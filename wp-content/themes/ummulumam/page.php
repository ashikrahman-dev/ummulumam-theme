...
<!-- Page banner -/Start -->
<section class="page-banner" style="background: url('<?php echo get_template_directory_uri(); ?>/assets/images/subpage-banner-bg.jpg');">
    <div class="container">
        <div class="row">
            <div class="col-lg-7">
                <div class="page-breadcrumb">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb d-flex align-items-center mb-0 gap-2">
                            ...
                            <li>
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M8.91003 19.92L15.43 13.4C16.2 12.63 16.2 11.37 15.43 10.6L8.91003 4.08002" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>

                            </li>
                            <li class="breadcrumb-item active text-white" aria-current="page"><?php wp_title(''); ?></li>
                        </ol>
                    </nav>
                </div>
            </div>
